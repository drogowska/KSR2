...
Na podstawie danych zebranych w Tabeli nr. 4, na pierwszy plan wysuwają się wartości miar $T_4$, $T_9$, $T_{10}$, $T_{11}$, gdyż posiadają one we wszystkich, bądź w większości, uzyskanych wyników takie same wartości. 
