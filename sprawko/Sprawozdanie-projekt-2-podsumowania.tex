...
\subsubsection{Jednopodmiotowe podsumowanie lingwistyczne w pierwszej formie}
...
\begin{center}
  \begin{table}[h]
    ...
    7 & Less than 1000 people are/have age equals average [1.0] \\ \hline 
    8 & More than 5000 people are/have age equals significant [0.7983193]
  \end{tabularx}
\end{table}
\end{center}

W poniższej tabeli zostały zawarte wartości miar jakości uzyskanego podsumowania, przy czym wagi wykorzystane do
obliczenia podsumowania optymalnego były następujęce:
\begin{equation}
...
\begin{center}
  \begin{table}[h]
    ...
    8 & 0,798 & 0,094 & 0 & 0 & 1 & 0,761 & 0,894 & 0,999 & 0 & 0 & 0 & 0.7275262

  \end{tabularx}
\end{table}
\end{center}

\subsubsection{Jednopodomiotowe podsumowanie lingwistyczne w drugiej formie}
...
% \begin{table}[h]
% 
% Use Case Navn:          & Opret Server & d \\
% Scenarie:               & At oprette en server med bestemte regler som tillader folk at spille sammen. More Text more text More Text & dd \\
% 
% \end{table}
% 
