...
\begin{enumerate}
  ...
  \item importance\_same\_religion 
    ...
    \begin{equation}
      \mu_{znacząca} = e^{-{(x-6)}^2}, dla x \in [5,7]
    \end{equation}

    \begin{equation}
      \mu_{spora} = e^{-(\frac{x-9}{1.5})^2}, dla x \in [7,10]
    \end{equation}
  ...
  \begin{equation}
    \mu_{średnio ambitny} = e^{-(\frac{x-30}{10})^2}, dla x \in [5,52]
  \end{equation}
