...
public class SpeedDatingRecord {
    ...
    private float attractive_important;
    ...
    private float attractive_partner;
    ...
    private float interests_correlate;
    private String d_interests_correlate;
    private float expected_happy_with_sd_people;
