...
public class Extractor {
    ...
    public static double expected_num_interested_in_me(CustomRecord record) {
        return record.getExpected_num_interested_in_me();
    }

    public static double guess_prob_liked(CustomRecord record) {
        return record.getGuess_prob_liked();
    }
    public static double tvsports(CustomRecord record) {
        return record.getTvsports();
    }
    public static double sincere(CustomRecord record) {
        return record.getSincere();
    }
